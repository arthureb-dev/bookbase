...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/ujackson/projects/bookbase/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/ujackson/projects/bookbase/public/storage','logging.default','logging.deprecations.channel',
...
'cors.supports_credentials','debugbar.enabled','debugbar.hide_empty_tabs','debugbar.except','debugbar.storage.enabled',
...
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','model-states.default_transition','structure-discoverer.ignored_files',
'structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver','structure-discoverer.cache.store','audit.enabled','audit.implementation',
...
'debugbar.queries.explain','home','books.manage','books.search',
'books.checkout','books.review','books.index','books.create','books.store',
'books.show','books.edit','books.update','books.destroy','audits.index','profile.edit','profile.update','profile.destroy','password.edit',
